...
%% des Dokuments.
\setzematrikelnr{}
\setzekurs{Mobile Computing (T3M40401)}
\setzetitel{Dokumentation der Payment App \glqq Payero\grqq{}}
...
\setzedhbw{Center for Advanced Studies}
\setzebetreuer{Prof. Dr.-Ing. Dipl.-Inf. Kai Becher}
\setzegutachter{}
\setzezeitraum{4 Wochen}
\setzearbeit{Mobile Computing (T3M40401)}
\setzeautor{Calvin Reibenspieß und Florian Brändle}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
