...
Zur Umsetzung des Datenbank-Schemas wurde das in \ref{fig:er_diagramm} dargestellte Entity-Relationship-Diagramm in Chen-Notation entworfen.
...
\\
In \ref{fig:apidesign} wird dargestellt, welche API-Endpunkte umgesetzt werden sollten:
